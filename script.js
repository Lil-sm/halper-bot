...
function changeLanguage() {
    ...
    if (language === 'ar') {
        document.querySelector('h1').innerText = 'مرحبا بك في بوت ديسكورد';
        ...
        document.querySelector('h1').innerText = 'Welcome to Discord Bot';
...
// Invite bot function
function inviteBot() {
    window.location.href = 'https://discord.com/oauth2/authorize?client_id=1308559793711218728&permissions=8&integration_type=0&scope=bot';
}

// Join server function
function joinServer() {
    window.location.href = 'https://discord.gg/wfcfGhXH';
}